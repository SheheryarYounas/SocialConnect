...
const Navbar = () => {
    ...
    const isNonMobileScreens = useMediaQuery("(min-width: 1000px)") // 1000px is the breakpoint for mobile screens. Anything above that is non-mobile screens.
        ...
        <FlexBetween padding="1rem 6%" backgroundColor={alt}> 
            ...
            {!isNonMobileScreens && isMobileMenuToggled && (
                <Box position='fixed' right='0' bottom='0' height='100%' zIndex="10" maxWidth='500px' minWidth='300px' backgroundColor={background}>
                    {/* CLOSE ICON */}
                    <Box display="flex" justify-content="flex-end" padding="1rem">
